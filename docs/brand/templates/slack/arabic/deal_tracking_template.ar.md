---
title: "تتبع الصفقات"
description: "تتبع صفقات المبيعات عبر مراحل خط الأنابيب"
...
تتبع صفقات المبيعات عبر مراحل خط الأنابيب

يوفر هذا القالب نهجًا منظمًا لـتتبع الصفقات داخل مؤسستك،
...
> مرحبًا بكم في [تتبع الصفقات]! تعمل هذه القناة كمركز مركزي لـتتبع صفقات المبيعات عبر مراحل خط الأنابيب.
>
> **روابط سريعة:**
> - [التوثيق](#)
> - [الإرشادات](#)
