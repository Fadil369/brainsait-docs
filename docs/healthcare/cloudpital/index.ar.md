...
### 💰 [قدرات RCM](rcm_capabilities.ar.md)
...
### 🔗 [تكامل نفيس](nphies_integration.ar.md)
...
2. **استكشف ميزات كلاودبيتال**
   - اقرأ [ميزات EMR](emr_features.ar.md) للقدرات السريرية
   - راجع [قدرات RCM](rcm_capabilities.ar.md) لسير عمل الفوترة
   - تحقق من [تكامل نفيس](nphies_integration.ar.md) للامتثال
...
### المجال التقني
- [منظومة LINC](../../tech/agents/linc_ecosystem.ar.md)
- [مرجع API](../../tech/apis/overview.ar.md)
- [هندسة النظام](../../tech/architecture/overview.ar.md)
