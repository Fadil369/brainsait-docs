...
- **Status:** In effect
- **Documentation:** [HIPAA PDPL Alignment](../healthcare/nphies/hipaa_pdpl_alignment.md)
- **Key Requirements:**
  - Consent management
  - Data subject rights
  - Breach notification
...
- **Status:** In effect
- **Documentation:** [Compliance SOP](../healthcare/sop/compliance_sop.md)
- **Key Requirements:**
...
#### NPHIES Standards
- **Status:** Mandatory
- **Documentation:** [NPHIES Overview](../healthcare/nphies/overview.md)
- **Key Requirements:**
  - FHIR R4 compliance
  - API standards
  - Data validation
...
- [Security](../tech/infrastructure/security.md)
- [SecUnit](../tech/agents/secunit.md)
